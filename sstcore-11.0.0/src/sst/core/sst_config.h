...
#define LT_DLSEARCH_PATH "/lib64:/usr/lib64:/lib:/usr/lib:/usr/lib64/atlas:/usr/lib64/dyninst:/usr/lib64/mysql:/usr/lib64/octave/3.8.2:/usr/lib64/qt-3.3/lib:/opt/dell/srvadmin/lib64:/opt/dell/srvadmin/lib64/openmanage:/opt/dell/srvadmin/lib64:/opt/dell/srvadmin/lib64:/opt/dell/srvadmin/lib64/srvadmin-idrac:/opt/dell/srvadmin/lib64:/opt/dell/srvadmin/lib64/srvadmin-idrac7:/opt/dell/srvadmin/lib64:/opt/dell/srvadmin/lib64/srvadmin-isvc:/opt/dell/srvadmin/lib64:/opt/dell/srvadmin/lib64/openmanage:/opt/dell/srvadmin/lib64:/opt/dell/srvadmin/lib64/openmanage:/usr/lib64/tcl8.5"
...
#define SST_INSTALL_PREFIX "/work2/07431/tg867305/stampede2/sstcore-11.0.0/install"

/* Defines the linker used to build SST */
#define SST_LD "/opt/apps/xalt/xalt/bin/ld -m elf_x86_64"
...
#define SST_PYTHON_CPPFLAGS "-I/opt/apps/intel18/python2/2.7.15/include/python2.7 -I/opt/apps/intel18/python2/2.7.15/include/python2.7"

/* Defines the LDFLAGS needed to compile Python into SST */
#define SST_PYTHON_LDFLAGS "-lpython2.7 -ldl -lpthread -limf -lirc -lssp -lutil -limf -Xlinker -export-dynamic"
